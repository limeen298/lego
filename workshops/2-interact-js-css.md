...
1. **Solve each `User Stories`** inside [../client/v2/portfolio.js](../client/v2/portfolio.js) file with JavaScript
    ...
    <img src="./img/2-portfolio.png" width="50%"/>
...
* For the UX and UI, go back to the prototype you did in [step 0](./workshops/0-craft-your-conviction.md).
...
* 🏁 [Theme 2 - About Javascript](https://github.com/92bondstreet/inception/blob/main/themes/2.md#about-htmlcss)
* 🏁 [Theme 2 - About HTML/CSS](https://github.com/92bondstreet/inception/blob/main/themes/2.md#about-htmlcss)
